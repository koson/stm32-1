...
/* LCD 寄存器*/
#define rLCDCON1	(*(volatile unsigned long *)0x1f00000)
#define rLCDCON2	(*(volatile unsigned long *)0x1f00004)
#define rLCDCON3	(*(volatile unsigned long *)0x1f00040)
#define rLCDSADDR1	(*(volatile unsigned long *)0x1f00008)
#define rLCDSADDR2	(*(volatile unsigned long *)0x1f0000c)
#define rLCDSADDR3	(*(volatile unsigned long *)0x1f00010)
#define rREDLUT		(*(volatile unsigned long *)0x1f00014)
#define rGREENLUT	(*(volatile unsigned long *)0x1f00018)
#define rBLUELUT	(*(volatile unsigned long *)0x1f0001c)
#define rDP1_2		(*(volatile unsigned long *)0x1f00020)
#define rDP4_7		(*(volatile unsigned long *)0x1f00024)
#define rDP3_5		(*(volatile unsigned long *)0x1f00028)
#define rDP2_3		(*(volatile unsigned long *)0x1f0002c)
#define rDP5_7		(*(volatile unsigned long *)0x1f00030)
#define rDP3_4		(*(volatile unsigned long *)0x1f00034)
#define rDP4_5		(*(volatile unsigned long *)0x1f00038)
#define rDP6_7		(*(volatile unsigned long *)0x1f0003c)
#define rDITHMODE	(*(volatile unsigned long *)0x1f00044)
...
/* BDMA0 寄存器*/
#define rBDCON0		(*(volatile unsigned int*)0x1f80000)
#define rBDISRC0	(*(volatile unsigned int*)0x1f80004)
#define rBDIDES0	(*(volatile unsigned int*)0x1f80008)
#define rBDICNT0	(*(volatile unsigned int*)0x1f8000c)
#define rBDCSRC0	(*(volatile unsigned int*)0x1f80010)
#define rBDCDES0	(*(volatile unsigned int*)0x1f80014)
#define rBDCCNT0	(*(volatile unsigned int*)0x1f80018)
